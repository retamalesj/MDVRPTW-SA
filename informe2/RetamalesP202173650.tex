...
Desde una perspectiva empírica, este enfoque demostró una precisión sobresaliente en las 20 instancias de referencia del MDVRP-TW,
alcanzando un gap promedio del $0.00\%$ respecto a las BKS disponibles en su momento, logrando igualar o mejorar los
registros históricos en la casi totalidad de las 20 instancias de referencia del MDVRP-TW~\cite{VidalAG2013}.
